...
public class Lab27junittestcase {
  ...
  @Test
  public void testLab27junittestcase() throws Exception {
    driver.get(baseUrl + "/");
    ...
    // ERROR: Caught exception [ERROR: Unsupported command [getTable | id=schedtable.14.3 | ]]
